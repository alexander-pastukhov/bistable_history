...
## Model comparison
Models can be compared via `loo::loo_compare()` function of the `loo` package based on either a leave-one-out cross-validation `loo()` or WAIC `waic()` information criteria. Please refer to [@Vehtari2017] for method details.
